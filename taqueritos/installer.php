...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20201005_taqueritos_f9ebbfc06a51f6d78860_20201005050513_archive.zip';
	const ARCHIVE_SIZE		 = '19964014';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f9ebbfc-05050513';
    const SECONDARY_PACKAGE_HASH = 'bdb9986-05050513';
